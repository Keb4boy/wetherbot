...
API_TOKEN = '6004958969:AAGSzSgcYPobtuahoL_4VIQnXOMfixI16w4'
...
@dp.message_handler(content_types=["city"], state=ProfileStatesGroup.city)
...
@dp.message_handler(content_types=["start_date"], state=ProfileStatesGroup.start_date)
...
@dp.message_handler(content_types=["end_date"], state=ProfileStatesGroup.end_date)
